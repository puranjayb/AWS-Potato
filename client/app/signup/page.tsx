...
import { Heart, Mail, User, Lock, Eye, EyeOff, CheckCircle2 } from 'lucide-react'
...
interface AuthMutation {
  mutate: (data: Omit<SignupForm, 'confirmPassword'>) => void
  isPending: boolean
}
...
// Mock hook for demonstration - replace with your actual useSignup hook
const useSignup = (): AuthMutation => ({
  mutate: (data: Omit<SignupForm, 'confirmPassword'>): void => {
...
export default function SignupPage(): JSX.Element {
  ...
  const validateField = (field: keyof SignupForm, value: string): string | undefined => {
    switch (field) {
      case 'username':
          ...
          <div className="relative p-8 rounded-2xl backdrop-blur-lg bg-white/10 border border-white/20 shadow-2xl hover:bg-white/15 transition-all duration-300">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="group">
                ...
                {errors.confirmPassword && (
                  <p className="mt-1 text-sm text-red-400 animate-fadeIn">{errors.confirmPassword}</p>
                )}
              </div>
        ...
        <div className={`text-center transition-all duration-1000 delay-600 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <div className="relative p-6 rounded-2xl backdrop-blur-lg bg-white/5 border border-white/10 shadow-lg">
            ...
            <div className="relative z-10">
              <p className="text-sm text-white/70 mb-4 font-medium">What you`ll get:</p>
