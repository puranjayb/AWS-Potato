...
export default function ReportsPage(): JSX.Element {
  ...
  // Use real API hooks
  const { data: files = [], isLoading: loading, refetch: loadFiles } = useFiles(selectedProject)
    ...
    for (const file of Array.from(selectedFiles)) {
      ...
      try {
        ...
        const result = await upload.mutateAsync({
          file,
          projectId: selectedProject === 'all' ? 'health-reports' : selectedProject,
  ...
  const filteredFiles = files.filter(file => {
    ...
    const matchesFilter = selectedFilter === 'all' || file.content_type.includes(selectedFilter)
  ...
  const getFileIcon = (contentType: string): React.ComponentType<{ className?: string }> => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
            ...
            <div className="flex justify-between items-center py-4">
              ...
              <div className="flex items-center space-x-4">
                <div className="hidden sm:block text-right">
                  <p className="text-sm text-white font-medium">Reports Dashboard</p>
                  <p className="text-xs text-white/70">Manage your medical files</p>
                </div>
                <button
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 flex-1">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="pl-10 pr-8 py-3 rounded-lg backdrop-blur-sm bg-white/5 border border-white/20 text-white focus:outline-none focus:ring-2 focus:ring-blue-400/50 hover:bg-white/10 transition-all duration-300 appearance-none"
                  >
                ...
                <div className="relative">
                  <select
                    ...
                    className="px-4 py-3 rounded-lg backdrop-blur-sm bg-white/5 border border-white/20 text-white focus:outline-none focus:ring-2 focus:ring-blue-400/50 hover:bg-white/10 transition-all duration-300 appearance-none"
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="space-y-3 mb-4">
                        ...
                        {file.project_id && (
                          <div className="flex items-center text-sm text-white/70">
                            ...
                            <span className="capitalize">{file.project_id.replace('-', ' ')}</span>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="flex space-x-2">
                        ...
                        <button
                          ...
                          type="button"
                          onClick={() => console.log('Delete file:', file.file_id)}
                        >
        ...
        {/* Summary Stats */}
        <div className={`mt-8 transition-all duration-1000 delay-900 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <div className="relative p-6 rounded-2xl backdrop-blur-lg bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-white/20 shadow-2xl">
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              ...
              <div>
                ...
                <div className="text-white/70 text-sm">Successfully Uploaded</div>
              </div>
            </div>
          </div>
        </div>
